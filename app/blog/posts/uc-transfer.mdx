...
(not so) [Fun fact](https://www.ppic.org/publication/policy-brief-strengthening-californias-transfer-pathway/#:~:text=Despite%20recent%20progress%2C%20transfer%20rates,do%20so%20within%20two%20years.): *only 10% of California community college students transfer within two years; 19% in four :(*

**Edit as of January 2025**: An important distinction is that assist.org articulation courses will count for your transfer application, but many of these classes will not actually fulfill requirements when you get to the school. If you'd like to plan ahead for after your transfer, use the website [transferoloy.com](transferoloy.com). I'm adding this information as it was quite surprising to me when I had to retake 3 articulated computer science courses once I got to UCLA.
...
- **networking**: my biggest con. I feel like 2 years at university isn't enough to make as many connections  as I'd like. There are some internship programs for CC students though! I didn't look into it as much as I wish but you should.
